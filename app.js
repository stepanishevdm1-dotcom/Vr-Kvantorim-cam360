...
const scenes = {
  ...
  'fork_3': {
    ...
    hotspots: [
      ...
      { yaw: -0.8413, pitch: -0.1466, label: 'Кабинет IT-квантум 1', target: 'cab_it1' }
    ]
  },
  'floor_3_1': {
    name: 'Третий этаж 1',
  ...
  'floor_3_8': {
    ...
    hotspots: [
      ...
      { yaw: 2.9112, pitch: -0.1239, label: 'Кабинет Промышленный дизайн 1', target: 'cab_prom1' }
    ]
  },
  'floor_3_9': {
    name: 'Третий этаж 9',
  ...
  'floor_3_10': {
    ...
    hotspots: [
      ...
      { yaw: 7.6254, pitch: -0.0908, label: 'Робоквантум 1', target: 'cab_robok1' }
    ]
  },
  'floor_3_11': {
    name: 'Третий этаж 11',
  ...
  'floor_3_12': {
    ...
    hotspots: [
      ...
      { yaw: -1.9234, pitch: -0.1501, label: 'Кабинет Робоквантум 2', target: 'cab_robok2' }
    ]
  },
  'floor_3_13': {
    name: 'Третий этаж 13',
  ...
  'floor_3_14': {
    ...
    hotspots: [
      { yaw: 2.336, pitch: -0.01571, label: 'Третий этаж 15', target: 'floor_3_15' },
      { yaw: -0.7505, pitch: -0.1100, label: 'Третий этаж 13', target: 'floor_3_13' },
      { yaw: 7.0826, pitch: -0.1361, label: 'Кабинет 304', target: 'cab_304' }
    ]
  },
  'floor_3_15': {
    name: 'Третий этаж 15',
    variants: [
      { label: 'Третий этаж 15', image: '3 этаж 15.jpg' }
    ],
    hotspots: [
      { yaw: -0.3246, pitch: -0.09076, label: 'Третий этаж 16', target: 'floor_3_16' },
      { yaw: -2.040, pitch: -0.09425, label: 'Третий этаж 14', target: 'floor_3_14' }
    ]
  },
  'floor_3_16': {
    name: 'Третий этаж 16',
    variants: [
      { label: 'Третий этаж 16', image: '3 этаж 16.jpg' }
    ],
    hotspots: [
      { yaw: 0.7925, pitch: -0.05062, label: 'Третий этаж 17', target: 'floor_3_17' },
      { yaw: -2.109, pitch: -0.1362, label: 'Третий этаж 15', target: 'floor_3_15' }
    ]
  },
  'floor_3_17': {
    name: 'Третий этаж 17',
    variants: [
      { label: 'Третий этаж 17', image: '3 этаж 17.jpg' }
    ],
    hotspots: [
      { yaw: 4.049, pitch: -0.09600, label: 'Третий этаж 16', target: 'floor_3_16' },
      { yaw: 0.8988, pitch: -0.06632, label: 'Третий этаж 18', target: 'floor_3_18' }
    ]
  },
  'floor_3_18': {
    name: 'Третий этаж 18',
    variants: [
      { label: 'Третий этаж 18', image: '3 этаж 18.jpg' }
    ],
    hotspots: [
      { yaw: 6.376, pitch: -0.09600, label: 'Третий этаж 19', target: 'floor_3_19' },
      { yaw: 3.266, pitch: -0.07679, label: 'Третий этаж 17', target: 'floor_3_17' }
    ]
  },
  'floor_3_19': {
    name: 'Третий этаж 19',
  ...
  'chess_lounge': {
    ...
    hotspots: [
      { yaw: 0.9444, pitch: -0.09425, label: 'Третий этаж 19', target: 'floor_3_19' },
      { yaw: 2.485, pitch: -0.05062, label: 'Третий этаж 20', target: 'floor_3_20' }
    ]
  },
  'floor_3_20': {
    name: 'Третий этаж 20',
    variants: [
      { label: 'Третий этаж 20', image: '3 этаж 20.jpg' }
    ],
    hotspots: [
      { yaw: 5.796, pitch: -0.1501, label: 'Шахматная гостиная', target: 'chess_lounge' },
      { yaw: 2.667, pitch: -0.01047, label: 'Третий этаж 21', target: 'floor_3_21' }
    ]
  },
  'floor_3_21': {
    name: 'Третий этаж 21',
    variants: [
      { label: 'Третий этаж 21', image: '3 этаж 21.jpg' }
    ],
    hotspots: [
      { yaw: 3.719, pitch: -0.06981, label: 'Третий этаж 20', target: 'floor_3_20' },
      { yaw: 0.5690, pitch: -0.06109, label: 'Третий этаж 22', target: 'floor_3_22' }
    ]
  },
  'floor_3_22': {
    name: 'Третий этаж 22',
    variants: [
      { label: 'Третий этаж 22', image: '3 этаж 22.jpg' }
    ],
    hotspots: [
      { yaw: 6.815, pitch: -0.1065, label: 'Третий этаж 23', target: 'floor_3_23' },
      { yaw: 3.681, pitch: -0.04538, label: 'Третий этаж 21', target: 'floor_3_21' }
    ]
  },
  'floor_3_23': {
    name: 'Третий этаж 23',
  ...
  'floor_3_24': {
    name: 'Третий этаж 24',
    variants: [
      { label: 'Третий этаж 24', image: '3 этаж 24.jpg' }
    ],
    hotspots: [
  ...
  'floor_3_25': {
    name: 'Третий этаж 25',
    variants: [
      { label: 'Третий этаж 25', image: '3 этаж 25.jpg' }
    ],
    hotspots: [
      { yaw: 2.182, pitch: -0.001745, label: 'Третий этаж 26', target: 'floor_3_26' },
      { yaw: -0.9425, pitch: -0.04189, label: 'Третий этаж 24', target: 'floor_3_24' },
      { yaw: 0.5899, pitch: -0.0716, label: 'Кабинет Хай-Тек цех 1', target: 'cab_hitech1' }
    ]
  },
  'floor_3_26': {
    name: 'Третий этаж 26',
  ...
  'floor_3_27': {
    ...
    hotspots: [
      { yaw: -0.5987, pitch: -0.07854, label: 'Третий этаж 26', target: 'floor_3_26' },
      { yaw: -3.779, pitch: -0.02443, label: 'Третий этаж 28', target: 'floor_3_28' }
    ]
  },
  'floor_3_28': {
    name: 'Третий этаж 28',
    variants: [
      { label: 'Третий этаж 28', image: '3 этаж 28.jpg' }
    ],
    hotspots: [
      { yaw: 2.225, pitch: -0.06981, label: 'Третий этаж 29', target: 'floor_3_29' },
      { yaw: -0.7907, pitch: -0.05411, label: 'Третий этаж 27', target: 'floor_3_27' }
    ]
  },
  'floor_3_29': {
    name: 'Третий этаж 29',
    ...
    hotspots: [
      ...
      { yaw: 1.3142, pitch: -0.1047, label: 'Кабинет IT-квантум 1', target: 'cab_it1' }
    ]
  },
  'cab_prom1': {
    name: 'Кабинет Промышленный дизайн 1',
    variants: [
  ...
  'cab_prom2': {
    ...
    hotspots: [
      { yaw: 4.0597, pitch: -0.0838, label: 'Кабинет Промышленный дизайн 1', target: 'cab_prom1' },
      { yaw: 3.3510, pitch: -0.0035, label: 'Третий этаж 8', target: 'floor_3_8' }
    ]
  },
  'cab_robok1': {
    name: 'Робоквантум 1',
  ...
  'cab_robok2': {
    name: 'Кабинет Робоквантум 2',
    variants: [
      { label: 'Кабинет Робоквантум 2', image: 'робоквантум 2.jpg' }
    ],
    hotspots: [
      { yaw: 2.3475, pitch: -0.0803, label: 'Третий этаж 12', target: 'floor_3_12' },
      { yaw: 3.7979, pitch: -0.0593, label: 'Аэроквантум', target: 'cab_aero' }
    ]
  },
  'cab_304': {
    name: 'Кабинет 304',
  ...
  'cab_it2': {
    ...
    hotspots: [
      { yaw: 0.7313, pitch: -0.0803, label: 'Кабинет IT-квантум 1', target: 'cab_it1' }
    ]
  },
  'cab_radio': {
    ...
    hotspots: [
      { yaw: 1.5551, pitch: -0.1152, label: 'Кабинет 304', target: 'cab_304' }
    ]
  },
  'cab_energy1': {
  ...
  'cab_aero': {
    ...
    hotspots: [
      { yaw: 6.9604, pitch: -0.0768, label: 'Робоквантум 1', target: 'cab_robok1' },
      { yaw: 3.8066, pitch: -0.0262, label: 'Кабинет Робоквантум 2', target: 'cab_robok2' }
    ]
  }
};
...
const sceneNamesEn = {
  ...
  'floor_3_15': '3rd Floor Room 15',
  'floor_3_16': '3rd Floor Room 16',
  'floor_3_17': '3rd Floor Room 17',
  'floor_3_18': '3rd Floor Room 18',
  'floor_3_19': '3rd Floor Room 19',
  'chess_lounge': 'Chess Lounge',
  'floor_3_20': '3rd Floor Room 20',
  'floor_3_21': '3rd Floor Room 21',
  'floor_3_22': '3rd Floor Room 22',
  'floor_3_23': '3rd Floor Room 23',
  'floor_3_24': '3rd Floor Room 24',
  'floor_3_25': '3rd Floor Room 25',
  'floor_3_26': '3rd Floor Room 26',
  'floor_3_27': '3rd Floor Room 27',
  'floor_3_28': '3rd Floor Room 28',
  'floor_3_29': '3rd Floor Room 29',
  'cab_prom1': 'Industrial Design Room 1',
  'cab_prom2': 'Industrial Design Room 2',
  'cab_robok1': 'Roboquantum 1',
  'cab_robok2': 'Roboquantum Room 2',
  'cab_304': 'Room 304',
  'cab_lecture': 'Lecture Hall',
  'cab_hitech1': 'Hi-Tech Workshop 1',
...
const hotspotLabelEn = {
  ...
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 15': 'Floor 3 Room 15',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 16': 'Floor 3 Room 16',
  ...
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 20': 'Floor 3 Room 20',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 21': 'Floor 3 Room 21',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 22': 'Floor 3 Room 22',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 23': 'Floor 3 Room 23',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 24': 'Floor 3 Room 24',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 25': 'Floor 3 Room 25',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 26': 'Floor 3 Room 26',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 27': 'Floor 3 Room 27',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 28': 'Floor 3 Room 28',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 29': 'Floor 3 Room 29',
  ...
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u041f\u0440\u043e\u043c\u044b\u0448\u043b\u0435\u043d\u043d\u044b\u0439 \u0434\u0438\u0437\u0430\u0439\u043d 1': 'Industrial Design Room 1',
  '\u0420\u043e\u0431\u043e\u043a\u0432\u0430\u043d\u0442\u0443\u043c 1': 'Roboquantum 1',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u0420\u043e\u0431\u043e\u043a\u0432\u0430\u043d\u0442\u0443\u043c 2': 'Roboquantum Room 2',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 304': 'Room 304',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u041b\u0435\u043a\u0442\u043e\u0440\u0438\u0439': 'Lecture Hall',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u0425\u0430\u0439-\u0422\u0435\u043a \u0446\u0435\u0445 1': 'Hi-Tech Workshop 1',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u0425\u0430\u0439-\u0422\u0435\u043a \u0446\u0435\u0445 2': 'Hi-Tech Workshop 2',
...
const variantLabelEn = {
  ...
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 15': '3rd Floor Room 15',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 16': '3rd Floor Room 16',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 17': '3rd Floor Room 17',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 18': '3rd Floor Room 18',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 19': '3rd Floor Room 19',
  '\u0428\u0430\u0445\u043c\u0430\u0442\u043d\u0430\u044f \u0433\u043e\u0441\u0442\u0438\u043d\u0430\u044f': 'Chess Lounge',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 20': '3rd Floor Room 20',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 21': '3rd Floor Room 21',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 22': '3rd Floor Room 22',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 23': '3rd Floor Room 23',
  ...
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 28': '3rd Floor Room 28',
  '\u0422\u0440\u0435\u0442\u0438\u0439 \u044d\u0442\u0430\u0436 29': '3rd Floor Room 29',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u041f\u0440\u043e\u043c\u044b\u0448\u043b\u0435\u043d\u043d\u044b\u0439 \u0434\u0438\u0437\u0430\u0439\u043d 1': 'Industrial Design Room 1',
  '\u0420\u043e\u0431\u043e\u043a\u0432\u0430\u043d\u0442\u0443\u043c 1': 'Roboquantum 1',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u0420\u043e\u0431\u043e\u043a\u0432\u0430\u043d\u0442\u0443\u043c 2': 'Roboquantum Room 2',
  '\u041a\u0430\u0431\u0438\u043d\u0435\u0442 304': 'Room 304',
  ...
  return new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main() {
        ...
        float bottomZone = 1.0 - smoothstep(0.0, 0.24, vUv.y);
        if (bottomZone > 0.0) {
          vec2 ts = vec2(2.5 / texWidth, 2.5 / texHeight);
          vec3 bcol = vec3(0.0);
          ...
          bcol += texture2D(tDiffuse, vUv + vec2(ts.x, ts.y)).rgb;
          bcol *= 0.125;
          vec2 ts2 = vec2(5.0 / texWidth, 5.0 / texHeight);
          vec3 bcol2 = vec3(0.0);
          bcol2 += texture2D(tDiffuse, vUv + vec2(-ts2.x, -ts2.y)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(0.0, -ts2.y)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(ts2.x, -ts2.y)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(-ts2.x, 0.0)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(ts2.x, 0.0)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(-ts2.x, ts2.y)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(0.0, ts2.y)).rgb;
          bcol2 += texture2D(tDiffuse, vUv + vec2(ts2.x, ts2.y)).rgb;
          bcol2 *= 0.125;
          bcol = mix(bcol, bcol2, 0.5);
